...
class __TwigTemplate_f978fd15fcb8c10bdbdc32c1e98292b6 extends Template
{
    ...
    ";
      ...
      <div class=\"mb-1\" style=\"min-height: 140px;\">
        <a href=\"";
            ...
            yield "\" data-path=\"";
            yield CoreExtension::getAttribute($this->env, $this->source, $context["image"], "path", [], "any", false, false, false, 45);
...
";
    ...
    {
        return array (  197 => 56,  195 => 55,  192 => 54,  186 => 53,  184 => 52,  176 => 49,  170 => 48,  156 => 45,  152 => 43,  147 => 42,  141 => 41,  139 => 40,  131 => 37,  125 => 36,  119 => 33,  115 => 31,  110 => 30,  108 => 29,  98 => 22,  94 => 21,  83 => 13,  77 => 12,  70 => 8,  66 => 7,  62 => 6,  58 => 5,  52 => 4,  46 => 3,  42 => 1,);
    }
...
<div class=\"row row-cols-sm-3 row-cols-lg-4\">
  ...
  {% for image in images %}
    <div class=\"mb-3\">
      <div class=\"mb-1\" style=\"min-height: 140px;\">
        <a href=\"{{ image.href }}\" data-path=\"{{ image.path }}\" class=\"thumbnail mb-1\"><img src=\"{{ image.thumb }}\" alt=\"{{ image.name }}\" title=\"{{ image.name }}\" class=\"img-fluid\"/></a>
      </div>
      <div class=\"form-check\">
...
{% endif %}
", "admin/view/template/common/filemanager_list.twig", "/Applications/MAMP/htdocs/admin/view/template/common/filemanager_list.twig");
    }
}
